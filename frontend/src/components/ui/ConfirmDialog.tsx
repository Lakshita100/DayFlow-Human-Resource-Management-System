  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        ref={dialogRef}
        tabIndex={-1}
        className="relative mx-4 w-full max-w-md rounded-xl border border-gray-100 bg-white p-6 shadow-xl focus:outline-none"
      >
        <button
          onClick={onCancel}
        ...
        <div className="mt-5 flex items-center justify-end gap-2">
          ...
          <button
            onClick={onConfirm}
            disabled={loading}
            className={`inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-white transition-colors disabled:opacity-50 ${confirmColor}`}
          >
            {loading ? (
              <>

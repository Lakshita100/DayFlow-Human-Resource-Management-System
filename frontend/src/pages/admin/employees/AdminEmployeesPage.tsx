...
import { Search, Plus, Filter, ChevronLeft, ChevronRight, MoreHorizontal, Mail, Phone, Briefcase } from 'lucide-react';
  ...
  return (
    <PageContainer>
      <div className="space-y-6">
        ...
        {selectedEmployee && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/20 backdrop-blur-sm" onClick={() => setSelectedEmployee(null)}>
            <div className="w-full max-w-lg rounded-2xl border border-gray-100 bg-white p-6 shadow-dropdown" onClick={(e) => e.stopPropagation()}>
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{selectedEmployee.employeeId} &middot; {selectedEmployee.designation}</p>
                  </div>
                </div>
                <button onClick={() => setSelectedEmployee(null)} className="rounded-lg p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-600">&times;</button>
              </div>
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-600">
                  ...
                  {selectedEmployee.department} &middot; {selectedEmployee.employmentType.replace('_', ' ')}
                </div>
              </div>

              <div className="mt-6 flex gap-3">
                <button className="flex-1 rounded-lg border border-gray-200 px-4 py-2.5 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-50">
                  Edit Employee
                </button>
